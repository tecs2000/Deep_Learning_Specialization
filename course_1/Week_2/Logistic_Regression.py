...
# Images of shape (num_px, num_px, 3) in a numpy-array of shape (num_px ∗ num_px ∗ 3)
# After this, our training (and test) dataset is a numpy-array where each column represents a flattened image.
# train_set_x_flatten shape: (12288, 209), m = 209
# test_set_x_flatten shape: (12288, 50), m = 50
